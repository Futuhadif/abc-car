    		...
    		<div class="col-6">
				...
				<hr>
					...
					<div class="mb-3">
						...
						<input type="submit" name="Login" value="Sign In" class="btn" style="background-color: #22d1ee; color: black"></input>
					</form>
					<p class="mt-3"> New User? Click here to 
						<a href="register"  style="color: #3d5af1">Sign Up</a>
					</p>
				</div>
				<div class="col-6">
    				<img src="/images/image3.png" style="width:95%">
    			</div>
    		</div>
	</c:if>
</div>
