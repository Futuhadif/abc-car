...
<div class="col-lg-12">
		...
		<div class="row p-3">
			...
			<div class="tab-content" id="nav-tabContent">
											...
											<c:forEach items="${cars}" var="c" varStatus="status">
												<tr>
													...
													<td>
														...
														href="/deleteCarByUser?cid=${c.id}"> <i
				...
				<div class="tab-pane fade" id="nav-booked" role="tabpanel"
					aria-labelledby="nav-booked">
						<div class="container">
							<div class="row">
								<div class="col-12">
									<table class="table table-bordered">
												...
												<c:forEach items="${c.biddings}" var="b">
													...
													<c:if test="${bookDate != null}">
														<tr>
															...
															<td>${b.bookStatus}</td>
															<td>
																<a type="button" class="btn btn-primary" href="/buyAcc?cid=${c.id}&bid=${b.id}">
