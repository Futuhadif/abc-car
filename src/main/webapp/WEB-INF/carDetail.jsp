...
<div class="container mb-5">
	<div class="card mb-5">
		<div class="row g-0">
			...
			<div class="col-md-6">
				<div class="p-3 right-side">
					...
					<div class="d-flex">
						<div style="width: 300px;">
							<span class="fw-bold">Prices are all-inclusive</span>
								<ul>
									<li>1 Year Warranty</li>
									<li>Car Loan Processing Fees</li>
								</ul>
						</div>
						<div>
							<span class="fw-bold">Highlight</span>
								<ul>
									<li>Medium mileage</li>
									<li>Auto Retract Mirror</li>
			...
			<c:if test="${sellStatus == 'on sale'}"> 
				...
				<sf:form action="book" method="post" class="was-validated"
					...
					style="width: 500px; margin-left: 20px; margin-bottom : 10px">Buy car</button>
				</sf:form>
						</div>
						</c:if>
					</div>
		...
		<div class="col-lg-12">
		<h2 align="center" class="mb-5">Car Detail</h2>
				<div class="card mb-4">
					<div class="card-body">
						<div class="row">
							<div class="col-sm-2 ">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<sf:form action="bid" method="post" class="was-validated" modelAttribute="bidding">
					<div class="mb-3 mt-3">
						<label for="name" class="form-label">Bid Price (RP):</label> <input type="text" class="form-control"
